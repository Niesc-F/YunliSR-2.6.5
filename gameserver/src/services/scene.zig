...
pub fn onGetCurSceneInfo(session: *Session, _: *const Packet, allocator: Allocator) !void {
    ...
    //scene_info.KBBLJPLPLBC = 1; //leader_entity_id
    //scene_info.HCEJEBKDKHJ = 100; //world_id
    ...
    { // Character
        ...
        try scene_group.entity_list.append(.{
            ...
            .Motion = .{ .pos = .{ .x = -126161, .y = 11839, .z = 4782 }, .rot = .{ .y = 270920 } },
        });
    ...
    { // Calyx prop
        ...
        try scene_group.entity_list.append(.{
            ...
            .EntityId = 1337,
            .Prop = prop,
            .Motion = .{ .pos = .{ .x = -129879, .y = 11839, .z = 4742 }, .rot = .{} },
        });
